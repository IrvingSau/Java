...
public class SumAndAverage {
	...
	//Create a class function to figure out question1, with for loop
	...
	//Create a class function to figure out question2, with while loop
	...
	//Create a class function to figure out question3, do-while loop
